...
const steps = [
  ...
  { icon: MessageSquare, title: "3. Communicate & Pay", desc: "Buyer and operator communicate via the built-in trade chat. Payment details are issued there for the agreed method (bank wire, ACH, Faster Payments, SEPA or FPS)." },
