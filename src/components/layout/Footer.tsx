...
const comboLinks = [
  ...
  { label: "Buy USDT UK Bank Transfer", href: "/buy-usdt-uk-bank-transfer" },
  { label: "Buy ETH USA PayPal", href: "/buy-ethereum-usa-paypal" },
  { label: "Buy USDT Nigeria", href: "/buy-usdt-nigeria-bank-transfer" },
  ...
  { label: "Buy USDT Germany SEPA", href: "/buy-usdt-germany-sepa" },
  { label: "Buy USDT Canada Interac", href: "/buy-usdt-canada-interac" },
  { label: "Buy BTC Australia", href: "/buy-bitcoin-australia-bank-transfer" },
  { label: "Buy ETH India UPI", href: "/buy-ethereum-india-upi" },
  { label: "Buy SOL USA PayPal", href: "/buy-solana-usa-paypal" },
  { label: "Buy USDT UAE", href: "/buy-usdt-uae-bank-transfer" },
  { label: "Buy USDT Turkey", href: "/buy-usdt-turkey-bank-transfer" },
  { label: "Buy BTC UK Bank Transfer", href: "/buy-bitcoin-uk-bank-transfer" },
  { label: "Buy USDT Indonesia", href: "/buy-usdt-indonesia-bank-transfer" },
  { label: "Buy USDT Singapore", href: "/buy-usdt-singapore-bank-transfer" },
  { label: "Buy USDT Mexico", href: "/buy-usdt-mexico-bank-transfer" },
  { label: "Buy BTC Nigeria", href: "/buy-bitcoin-nigeria-bank-transfer" },
  { label: "Buy ETH UK Bank Transfer", href: "/buy-ethereum-uk-bank-transfer" },
  { label: "Buy SOL India UPI", href: "/buy-solana-india-upi" },
];
