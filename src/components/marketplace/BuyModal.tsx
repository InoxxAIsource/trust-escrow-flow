          ...
          <>
            ...
            <div className="space-y-4 mt-2">
              <div className="rounded-lg border border-success/30 bg-success/5 p-4 space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Locked price</span>
                  <span className="font-bold text-foreground">{sym}{offer.price.toLocaleString()}/{offer.assetSymbol}</span>
                </div>
              ...
              <div className="rounded-lg border p-3">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  ...
                  <p>2. Send <strong>{sym}{numAmount.toLocaleString()}</strong> via <strong>{payment}</strong></p>
