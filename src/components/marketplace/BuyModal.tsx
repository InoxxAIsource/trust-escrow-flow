            ...
            <div className="space-y-4 mt-2">
              <div className="rounded-lg border bg-muted/50 p-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-foreground">{offer.price.toLocaleString()} {currency}</span>
                </div>
            ...
            <div className="space-y-4 mt-2">
              <div className="rounded-lg border p-4 space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-foreground">{numAmount.toLocaleString()} {currency}</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-foreground">{offer.price.toLocaleString()} {currency}</span>
                </div>
                <div className="flex justify-between text-sm">
          ...
          <>
            ...
            <div className="space-y-4 mt-2">
              <div className="rounded-lg border border-success/30 bg-success/5 p-4 space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Locked price</span>
                  <span className="font-bold text-foreground">{offer.price.toLocaleString()} {currency}/{offer.assetSymbol}</span>
                </div>
              ...
              <div className="rounded-lg border p-3">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  <p>1. Send <strong>{numAmount.toLocaleString()} {currency}</strong> via <strong>{payment}</strong></p>
