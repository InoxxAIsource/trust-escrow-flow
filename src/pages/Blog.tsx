...
const Blog = () => (
  <>
    <SEOHead title="TrustP2P Blog — Crypto Trading Guides & News" description="Learn about P2P crypto trading, escrow protection, and how to buy and sell cryptocurrency safely. Guides, tips, and industry insights." />
